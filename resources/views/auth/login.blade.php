...
<div class="modal-dialog" style="width:400px;margin-top: 5%;">
    <div class="modal-content">
        <div class="modal-header" style="text-align:center">
            <img width="150px"  src="{{ asset('css/student_icon.svg') }}"></img>
          <h2 class="text-center">Hệ thống quản lý luận văn</h2>
          <h4 class="text-center">Phân hệ sinh viên</h4>
        </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                {{ csrf_field() }}
                 ...
                 <div class="form-group">
                     <input type="text" name="email" value="{{ old('email') }}" required autofocus class="form-control input-lg" placeholder="Tài khoản sinh viên"/>
                 </div>
